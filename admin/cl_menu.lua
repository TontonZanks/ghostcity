...
RMenu.Add('menu', 'main', RageUI.CreateMenu("Menu Administration", " "))
RMenu.Add('menu', 'options', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'joueurs', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'warn', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'sanction', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'actionstaff', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'perso', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'world', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'options', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'veh', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'customcolor', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'ped', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'lister', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
RMenu.Add('menu', 'gestr', RageUI.CreateSubMenu(RMenu:Get('menu', 'lister'), "Menu Administration", " "))
RMenu.Add('menu', 'time', RageUI.CreateSubMenu(RMenu:Get('menu', 'main'), "Menu Administration", " "))
        ...
        Citizen.CreateThread(function()
			while VM.Staff do
				RageUI.IsVisible(RMenu:Get('menu', 'main'), true, true, true, function()
					...
					if InStaff then
						RageUI.Separator("↓ ~r~Menu Staff~r~↓")
...
function admin_heal_player()
	...
	if plyId ~= nil then
		...
		if type(plyId) == 'number' then
			TriggerServerEvent('esx_ambulancejob:realdoxvive', plyId)
		end
	end
end
...
AddEventHandler('alert', function(msg)
	...
	AddTextEntry("FACES_WARNH2", "Alerte")
